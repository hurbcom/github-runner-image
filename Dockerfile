FROM ubuntu:20.04
ARG VERSION=2.278.0
RUN export DEBIAN_FRONTEND=noninteractive && apt update && apt -y install supervisor curl wget liblttng-ust0 libkrb5-3 zlib1g libssl1.1 libicu66 apt-transport-https && apt clean
